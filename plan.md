...
- [x] Updated UI success text for the updater component in admin.js to 'Updated sucessfully! You can close this window or go back to admin dashboard'.
- [x] Moved inline styles and HTML <style> tags to external CSS files (admin.css, user.css, login.css) in /css/ directory to strengthen theming (Bootstrap 5 dark mode variables).
